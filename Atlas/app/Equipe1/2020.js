...
map.on('click', 'annee2020', function (e) {
    ...
    var popupContent = '<h3>' + e.features[0].properties.score + ' vélo(s) comptabilisé(s) en 2020' + '</h3>'; // Vous pouvez personnaliser le contenu du popup en fonction de vos besoins
