...
map.on('click', 'annee2014', function (e) {
    ...
    var popupContent = '<h3>' + e.features[0].properties.score + ' vélos comptabilisés en 2014' + '</h3>'; // Vous pouvez personnaliser le contenu du popup en fonction de vos besoins
