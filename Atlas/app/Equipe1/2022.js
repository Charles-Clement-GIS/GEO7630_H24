...
map.on('click', 'annee2022', function (e) {
    ...
    var popupContent = '<h3>' + e.features[0].properties.score + ' vélo(s) comptabilisé(s) en 2022' + '</h3>'; // Vous pouvez personnaliser le contenu du popup en fonction de vos besoins
